...
<?php include'ticker.php'; ?>
  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <center><img src="image\BENEFITS-OF-BLOOD-DONATION.jpg" alt="image\BENEFITS-OF-BLOOD-DONATION.jpg" alt="centered image" width="80%" height="350"></center>
      </div>
      <div class="carousel-item">
      <center><img src="image\klkm.jpeg" alt="image\klkm.jpeg" alt="centered image" width="80%" height="350"></center>
      </div>
...
<br>
        <h1 style="text-align:center;font-size:45px;">Welcome to RaKtKosh <br> Electronic BloodBank</h1>
<br>
        <div class="row">
          ...
          <?php
           ...
           ?>
            ...
            <div class="card" style="width:200px">
                <img class="card-img-top" src="image\donor_logo1.jpeg" alt="Card image" style="width:100%;height:200px">
                <div class="card-body">
...
<br>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <a class="btn btn-lg btn-secondary btn-block" href="donate_blood.php" style="align:center; background-color:#C24641;color:#2FFFFF4 ">Become a Donor </a>
            </div>
        </div>
